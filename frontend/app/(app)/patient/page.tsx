...
export default function PatientAnalysisPage() {
    ...
    const healthScore = useMemo(() => {
        ...
        if (patient.sbp_mean_24h > 120) score -= (patient.sbp_mean_24h - 120) * 0.4;
        if (patient.dbp_mean_24h > 80) score -= (patient.dbp_mean_24h - 80) * 0.4;

        // Glucose (Ideal < 100 fasting, < 140 random) -> Taking 110 as safe base for random
        if (patient.glucose_mean_24h > 110) score -= (patient.glucose_mean_24h - 110) * 0.15;
        if (patient.glucose_mean_24h < 70) score -= (70 - patient.glucose_mean_24h) * 0.5;
                    ...
                    >
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            ...
                            <GlucoseChart
                                ...
                                baseGlucose={patient.glucose_mean_24h}
                            />
                        </div>
                    </motion.div>
                ) : (
